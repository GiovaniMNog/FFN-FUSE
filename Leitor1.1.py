...
def ocr_on_images(image_dir, output_csv):
...
if __name__ == "__main__":
    ...
    for pdf_file in os.listdir(pdf_directory):
        if pdf_file.endswith(".pdf"):
            ...
            output_csv = os.path.join(image_directory, f'data_{os.path.splitext(pdf_file)[0]}.csv')

            pdf_to_images(pdf_path, image_directory)
            ocr_on_images(image_directory, output_csv)
